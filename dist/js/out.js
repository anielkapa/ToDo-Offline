...
var _reactSortableHoc = __webpack_require__(74);
  ...
  var App = function (_Component) {
    ...
    function App(props) {
      ...
      _this.createList = function () {
        ...
        var SortableList = (0, _reactSortableHoc.SortableContainer)(function (_ref2) {
          ...
          return _react2.default.createElement(
            ...
            items.map(function (value, index) {
              return _react2.default.createElement(
                'div',
                { key: index, className: _this.state.active[index] },
                _react2.default.createElement(SortableItem, { key: 'items-' + index, index: index, value: value }),
                _react2.default.createElement(
                  'button',
                  { onClick: function onClick(e) {
                      return _this.doneItem(index);
                    }, key: 'done-' + index, className: _this.state.buttonActive[index], index: index },
                  '  '
                ),
                _react2.default.createElement(
                  'button',
                  { onClick: function onClick(e) {
                    ...
                    }, key: 'del-' + index, className: 'delete_button', index: index },
                  ' X '
                )
              );
            })
        ...
        var liList = _this.state.listToDo;
        if (liList.length === 0) {
          return null;
        } else {
          return _react2.default.createElement(SortableList, { items: _this.state.listToDo, onSortEnd: _this.onSortEnd });
        }
      };
      ...
      _this.onSortEnd = function (_ref3) {
        ...
        _this.setState({
          listToDo: (0, _reactSortableHoc.arrayMove)(_this.state.listToDo, oldIndex, newIndex),
          active: (0, _reactSortableHoc.arrayMove)(_this.state.active, oldIndex, newIndex),
          buttonActive: (0, _reactSortableHoc.arrayMove)(_this.state.buttonActive, oldIndex, newIndex)
        });
      };

      _this.newToDo = function (event) {
        _this.setState({ value: event.target.value });
      };

      _this.addToList = function (event) {
        event.preventDefault();
        var submited = _this.state.value;
        _this.setState({
          value: '',
          listToDo: [_this.state.value].concat(_toConsumableArray(_this.state.listToDo)),
          active: ['active'].concat(_toConsumableArray(_this.state.active)),
          buttonActive: ['undone_button'].concat(_toConsumableArray(_this.state.buttonActive))
        });
      };

      _this.deleteItem = function (index) {
        var listUpdated = _this.state.listToDo;
        var activeUpdated = _this.state.active;
        var activeButton = _this.state.buttonActive;
        listUpdated.splice(index, 1);
        activeUpdated.splice(index, 1);
        activeButton.splice(index, 1);
        _this.setState({ listToDo: listUpdated, active: activeUpdated, buttonActive: activeButton });
      };

      _this.doneItem = function (index) {
        var activeList = _this.state.active;
        var activeButton = _this.state.buttonActive;
        ...
        _this.setState({ active: activeList, buttonActive: activeButton });
      };
...
var m=__webpack_require__(35),n=__webpack_require__(14),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(36),B=__webpack_require__(37),C=__webpack_require__(4),ba=__webpack_require__(38),da=__webpack_require__(39),ea=__webpack_require__(40),fa=__webpack_require__(41),ia=__webpack_require__(42),D=__webpack_require__(14);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('input', { value: this.props.value, placeholder: ' add to-do ', type: 'text', onChange: this.props.newToDo }),
          _react2.default.createElement(
            'button',
            { className: 'add_button', onClick: this.props.addToList },
            '+'
          )
        )
      );
...
var Today = function (_Component) {
  ...
  function Today(props) {
    ...
    _this.getWeekday = function () {
      var weekNameArray = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
      var weekdayName = weekNameArray[_this.state.weekday];
      var toReturn = weekdayName.toUpperCase();
      return toReturn;
    };

    _this.getMonthName = function () {
      var monthNameArray = ["January", "February", "March", "April", "May", "June", "July", "August", 'September', 'October', 'November', 'December'];
      var monthName = monthNameArray[_this.state.month];
      var toUpper = monthName.toUpperCase();
      var toReturn = toUpper.substring(0, 3);
      return toReturn;
    };
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'date_dayMonthYear_dayMonth' },
            _react2.default.createElement(
              'span',
              null,
              ' ',
...
var _find = __webpack_require__(80);
